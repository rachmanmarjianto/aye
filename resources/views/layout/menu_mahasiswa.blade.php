    ...
    <div class="nav-section">
        ...
        <div class="nav-item @if($menu == 'pendaftaran') open @endif">
            ...
            <div class="nav-submenu">
                <a href="{{ route('mahasiswa.index') }}" class="nav-link @if($submenu == 'semua_pendaftaran') active @endif">
                    <span class="nav-link-text">Semua Pendaftaran</span>
                </a>
                <a href="{{ route('mahasiswa.pendaftaran_baru') }}" class="nav-link @if($submenu == 'pendaftaran_baru') active @endif">
                    <span class="nav-link-text">Pendaftaran Baru</span>
                </a>
